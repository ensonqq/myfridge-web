<template>
  <form id="payment-for-topup" @submit.prevent="submit">
    <div id="payment-element-topup">
      <!--Stripe.js injects the Payment Element-->
    </div>
    <div id="payment-message-topup" class="hidden"></div>
  </form>
</template>
...
export default {
  ...
  methods : {
    ...
    async initialize (orderPlaced) {
      ...
      paymentElement.mount("#payment-element-topup");
    },
    ...
    showMessage (messageText) {
      const messageContainer = document.querySelector("#payment-message-topup");
